...
(Zie https://r4css.vanatteveldt.com/chapters/02-funwithr.html#combining-data-sets-to-visualize-patterns
voor een uitleg van de kolommen)
...
# Laat zien hoe de gecombineerde gegevens eruit zien 
# (pas de naam 'data' eventueel aan aan hoe jullie het object hebben genoemd)
head(data)
```
...
9. Welke vragen zijn nog niet beantwoord, of welke nieuwe vragen zijn juist opgeworpen? Wat zijn beperkingen van deze gegevens of analyse? Hoe zou een vervolgonderzoek hier eventueel antwoord op kunnen geven? 
